...
inline bool check_nan(const std::optional<picoio::vm::operand_stack_elem>& v) {
   return visit(picoio::vm::overloaded{[](picoio::vm::i32_const_t){ return false; },
                                      [](picoio::vm::i64_const_t){ return false; },
                                      [](picoio::vm::f32_const_t f) { return std::isnan(f.data.f); },
                                      [](picoio::vm::f64_const_t f) { return std::isnan(f.data.f); }}, *v);
}

#define BACKEND_TEST_CASE(name, tags) \
  TEMPLATE_TEST_CASE(name, tags, picoio::vm::jit, picoio::vm::interpreter)
